...
def parse_args():
    ...
    parser.add_argument("--train_file", type=str, default='../data/data4.csv', help="train text file")
    parser.add_argument("--pretrained", type=str, default='../model/chinese-bert-wwm-ext',
                        help="huggingface pretrained model")
    parser.add_argument("--model_out", type=str, default="../model/SENET/out4", help="model output path")
