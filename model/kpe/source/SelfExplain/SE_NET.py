...
class SENet(nn.Module):
    ...
    def forward(self, input_ids, attention_mask, token_type_ids,word_segments,word_segments_len):
        ...
        for i in range(len(word_segments_len)):
            ...
            for word in word_list:
                if word not in word_dict:
                    word_dict[word] = self.get_word_embedding(last_hidden_state[i], input_ids, word)
            word_logit = {}
