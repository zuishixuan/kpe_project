...
from .JointKpe.ScoreAttenKpe import ScoreAttenKpe
...
def parse_args():
    ...
    parser.add_argument("--model_out", type=str, default="../model/ScoreAttenKpe/cnki_2/out2", help="model output path")
    parser.add_argument("--scorekpe_model", type=str, default="../model/ScoreAttenKpe/cnki_2/out2/epoch_2")
    ...
    parser = ScoreAttenKpe.add_model_specific_args(parser)
...
def train(args):
    ...
    model = ScoreAttenKpe(args=args).to(device)
    if local_rank != -1:
...
def tesk(args):
    ...
    model = ScoreAttenKpe(args=args).to(args.device)
