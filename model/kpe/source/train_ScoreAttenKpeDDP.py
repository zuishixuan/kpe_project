...
def parse_args():
    ...
    parser.add_argument("--model_out", type=str, default="../model/ScoreAttenKpe/cnki_2/out", help="model output path")
    parser.add_argument("--scorekpe_model", type=str, default="../model/ScoreAttenKpe/cnki_2/out/epoch_3")
