...
from .JointKpe.MarkAttenKpe import MarkAttenKpe
...
def parse_args():
    ...
    parser.add_argument("--markkpe_model", type=str, default="../model/MarkAttenKpe/cnki_2/out/epoch_1")
    ...
    parser = MarkAttenKpe.add_model_specific_args(parser)
...
def train(args):
    ...
    device_ids =[int(i) for i in args.gpu_no.split(',')]
    device = device_ids[0]
    ...
    train_dataloader = DataLoader(
        ...
        batch_size=batch_size * len(device_ids),  # 以小批量进行训练
    )
