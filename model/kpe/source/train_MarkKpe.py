...
from .JointKpe.MarkKpe import MarkKpe
...
def parse_args():
    ...
    parser.add_argument("--model_out", type=str, default="../model/MarkKpe/cnki_2/out", help="model output path")
    parser.add_argument("--markkpe_model", type=str, default="../model/MarkKpe/cnki_2/out/epoch_3")
    ...
    parser = MarkKpe.add_model_specific_args(parser)
...
def train(args):
    ...
    model = MarkKpe(args=args).to(args.device)
...
def tesk(args):
    ...
    text = '戏仿手法与反讽意图——石黑一雄《被埋葬的巨人》对骑士文学的借用。戏仿是后现代主义文学最重要的写作手法之一。日裔英籍小说家石黑一雄的新作被埋葬的巨人对骑士文学的体裁进行了戏仿,通过对这一经典文学体裁进行吸纳、借鉴和转换实现反讽的表意效果。在骑士文学中,石黑一雄最重要的戏仿对象是英国14世纪的骑士诗歌高文爵士与绿衣骑士。他借鉴了这首诗歌中高文爵士的形象,保持了其信守诺言、遵守骑士风度的品质,却把原本年轻的骑士写成了颓然老去的骑士。由此,石黑一雄探讨了有关人应该如何面对老年、死亡、遗忘与爱情等普遍性问题。本文结合高文爵士与绿衣骑士一诗来解读被埋葬的巨人,通过两篇文本的联系与区别来探寻作者的反讽意图,进而讨论作品的深刻主题。'
